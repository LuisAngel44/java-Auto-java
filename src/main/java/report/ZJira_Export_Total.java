...
public class ZJira_Export_Total {
    ...
    // IDs de Campos (Mantenemos tus constantes actuales)
    ...
    public static void main(String[] args) {
        ...
        String[] encabezados = {
                ...
                "Descripción del incidente", "Fecha Generación", "Fecha Solución",
                "Descripción Solución", "Tiempo solución", "Tiempo no disponibilidad", "Medio TX"
        };
        ...
        // JQL modificado para traer TODO el proyecto MSP
        String jqlQuery = "project = 'MSP' ORDER BY created ASC";

        System.out.println("🚀 Iniciando extracción total de tickets...");

        try {
            while (tieneMasPaginas) {
                ObjectNode payload = mapper.createObjectNode();
                payload.put("jql", jqlQuery);
                payload.put("maxResults", 100); // Aumentamos a 100 para ser más eficientes
                ...
                if (response.statusCode() == 200) {
                    ...
                    for (JsonNode issue : issues) {
                        ...
                        // Lógica de fechas (Manual vs Sistema)
    ...
    // --- MÉTODOS AUXILIARES (Sin cambios para mantener compatibilidad) ---
